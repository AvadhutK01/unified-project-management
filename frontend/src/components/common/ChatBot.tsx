...
const ChatBot = () => {
    ...
    // true = waiting for chat:reply:start (show typing dots)
    const [isPending, setIsPending] = useState(false);
    // true = chunks are streaming in (message exists but still growing)
    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex items-center gap-3 px-4 py-3 border-b bg-primary rounded-t-2xl">
                    ...
                    <button
                        ...
                        className="flex h-7 w-7 items-center justify-center rounded-full hover:bg-white/20 transition-colors text-white/80 hover:text-white"
                    >
                        <X size={15} />
                    </button>
                </div>
                ...
                <div className="px-3 py-3 border-t">
                    <div className="flex items-end gap-2 rounded-xl border bg-background px-3 py-2 focus-within:ring-2 focus-within:ring-primary/30 transition-all">
                        ...
                        <button
                            ...
                            className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-primary text-primary-foreground disabled:opacity-40 hover:bg-primary/90 transition-colors"
                        >
            ...
            <button
                onClick={() => setOpen((v) => !v)}
                className="fixed bottom-5 right-5 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 transition-all duration-200 hover:scale-110 active:scale-95"
            >
